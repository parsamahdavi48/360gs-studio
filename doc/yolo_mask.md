...
- On first run the script may download model files (.pt); this can take time. Put local `.pt` files under `models/ultralytics/` when you want to use local YOLO/SAM weights. Otherwise, Ultralytics resolves the named model.
