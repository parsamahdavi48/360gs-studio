...
STRINGS: dict[str, str] = {
    ...
    "SFM_MENU_DESC": "Choose the SfM result used to build training datasets. Use an existing Metashape, RealityScan, COLMAP, or SphereSfM result, or run COLMAP/SphereSfM from this app to create one.",
    ...
    "SFM_ROUTE_REALITYSCAN_BODY": "Create Cubemap images and XMP files for RealityScan realignment from a Metashape SfM result.",
    ...
    "SFM_ROUTE_SPHERESFM_BODY": "Process same-resolution equirectangular 360° images with SphereSfM to create camera poses and a sparse point cloud.",
    ...
    "SFM_SPHERESFM_DETAIL_DESC": "Process same-resolution 360° images with the SphereSfM COLMAP build and create a sparse model containing camera poses and points. Cubemap or GUT conversion from that sparse result is handled in the dataset step.",
    "SFM_REALITYSCAN_DETAIL_TITLE": "Metashape → RealityScan Data",
    "SFM_REALITYSCAN_DETAIL_DESC": "Create Cubemap images and XMP files for RealityScan from a Metashape SfM result plus source images and masks. Import output/realityscan/ into RealityScan, then export CSV/PLY after Align.",
    # Step 5
