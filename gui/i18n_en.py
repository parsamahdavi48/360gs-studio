...
STRINGS: dict[str, str] = {
    ...
    "METASHAPE_NOTICE": (
        ...
        "For the SphereSfM route, the Dataset step runs SfM and conversion, then writes either 3DGUT data or cubemap data.\n"
    ...
    # Step 4
    "SFM_MENU_TITLE": "SfM / Camera Alignment",
    "SFM_MENU_DESC": "Choose how camera poses are produced. COLMAP and SphereSfM run in this step; only already-prepared external SfM results move directly to dataset creation.",
    ...
    "SFM_ROUTE_EXTERNAL_TITLE": "Use External SfM Result",
    "SFM_ROUTE_EXTERNAL_BODY": "Use results already prepared in Metashape, COLMAP, SphereSfM, RealityScan, or another SfM tool. There is nothing to run in Step 4, so continue to dataset creation.",
    "SFM_ROUTE_EXTERNAL_FOOTER": "Next: choose the input source in Dataset",
    "SFM_ROUTE_COLMAP_TITLE": "Run COLMAP SfM",
    "SFM_ROUTE_COLMAP_BODY": "Prepare Cubemap images, then estimate camera poses with COLMAP or GLOMAP.",
    "SFM_ROUTE_COLMAP_FOOTER": "Output: output/colmap_rig/",
    "SFM_ROUTE_SPHERESFM_TITLE": "SphereSfM",
    "SFM_ROUTE_SPHERESFM_BODY": "Estimate camera poses from 360 images with the SphereSfM COLMAP build.",
    ...
    "SFM_SPHERESFM_DETAIL_TITLE": "SphereSfM",
    "SFM_SPHERESFM_DETAIL_DESC": "Process extracted 360 images with the SphereSfM COLMAP build and create a sparse model. Cubemap or 3DGUT conversion from that sparse result is handled in the dataset step.",
    # Step 5
    "DATASET_MENU_TITLE": "Training Dataset Creation",
    "DATASET_MENU_DESC": "Choose the required pre-training conversion or correction by its actual input source. COLMAP SfM output in output/colmap_rig/ is already a COLMAP dataset and can skip this step.",
    "DATASET_SELECT_TOOL": "Choose Tool",
    "DATASET_BACK_TO_MENU": "← Dataset Menu",
    "DATASET_TOOL_METASHAPE_TITLE": "Metashape Result → Cubemap / 3DGUT",
    "DATASET_TOOL_METASHAPE_DESC": "Create Postshot, Brush, or LichtFeld training datasets from Metashape XML/PLY plus source images and masks.",
    "DATASET_TOOL_METASHAPE_CARD_BODY": "Convert camera results prepared in Metashape into Cubemap or 3DGUT training data.",
    "DATASET_TOOL_METASHAPE_CARD_FOOTER": "Input: XML / PLY / images / masks",
    "DATASET_TOOL_SPHERESFM_TITLE": "SphereSfM Result → Training Dataset",
    "DATASET_TOOL_SPHERESFM_DESC": "Create Cubemap or 3DGUT training data from the SphereSfM sparse model made in Step 4, or from another selected SphereSfM sparse model.",
    "DATASET_TOOL_SPHERESFM_CARD_BODY": "Convert a SphereSfM sparse model into training data for LichtFeld, Postshot, or Brush.",
    ...
    "DATASET_TOOL_RS_LFS_TITLE": "RealityScan → LichtFeld",
    "DATASET_TOOL_RS_LFS_DESC": "Convert RealityScan CSV and PLY exports into a COLMAP dataset root that LichtFeld can load as a Dataset. Existing images and masks are linked when possible; only required transformed assets are written.",
    "DATASET_TOOL_RS_LFS_CARD_BODY": "Create a LichtFeld COLMAP dataset from RealityScan CSV/PLY exports.",
    ...
    "RS_LFS_DISTORTION_MODE": "Distortion",
    "RS_LFS_PRE_UNDISTORT": "Pre-undistort to PINHOLE",
    "RS_LFS_UNDISTORT_ALPHA": "Undistort Alpha",
...
TIPS: dict[str, str] = {
    ...
    "SFM_ROUTE_EXTERNAL": "Use camera results already prepared in Metashape, COLMAP, SphereSfM, RealityScan, or another SfM tool. Step 4 has nothing to run for this route, so it opens the dataset step.",
    "SFM_ROUTE_COLMAP": "Prepare Cubemap images in this app and run COLMAP/GLOMAP. Configure the run inside Step 4.",
    "SFM_ROUTE_SPHERESFM": "Process 360 images with the SphereSfM COLMAP build. Step 4 runs SfM; dataset conversion is handled in the dataset step.",
    ...
    "DATASET_TOOL_METASHAPE": "Use Metashape XML/PLY as the input and create Cubemap or 3DGUT training data.",
    "DATASET_TOOL_SPHERESFM": "Use a SphereSfM sparse model as the input and create Cubemap or 3DGUT training data. Run SfM itself in Step 4.",
    "DATASET_COLMAP_READY_ACTION": "There is nothing to run in this step for COLMAP output. Continue to the training step from the left navigation.",
    ...
    "RS_LFS_PRE_UNDISTORT": "Pre-undistort only RealityScan rows with distortion coefficients and write them as PINHOLE cameras. Existing PINHOLE/Cubemap images remain linked.",
    "RS_LFS_UNDISTORT_ALPHA": "0 crops black borders; 1 keeps more field of view. Start with 0 for normal use.",
...
TIPS.update(
    {
        ...
        "LFS_GUT": "Train on a 3DGUT dataset. This can use 360 images directly with less projection distortion, but usually costs more VRAM than cubemap training.",
