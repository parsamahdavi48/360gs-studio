...
STRINGS: dict[str, str] = {
    ...
    "REVIEW_RENUMBER_BLOCKED": "Renumbering is unavailable because masks or Step 4 outputs already exist.",
    ...
    "SCENE_PREVIEW_NO_CANDIDATES": "No SfM result or Step 4 output was found.",
...
TIPS: dict[str, str] = {
    ...
    "REVIEW_RENUMBER_KEPT_IMAGES": "When applying, rename kept images in CSV order starting at images/frame_000001.ext. Use this only before mask generation and Step 4 export",
    ...
    "SCENE_PREVIEW_OPEN": "Open a read-only preview of SfM results or Step 4 output to inspect cameras, points, and image links.",
    "SCENE_PREVIEW_SELECT_SCENE": "Select the scene folder to inspect in the read-only preview.",
    "SCENE_PREVIEW_REFRESH": "Rescan the scene folder for SfM results and Step 4 output.",
