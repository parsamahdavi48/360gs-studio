...
STRINGS: dict[str, str] = {
    ...
    "STEP6_NAV": "6\nTrain",
    "STEP7_NAV": "7\nViews",
    "SHELL_VIEW_MENU": "View",
    "SHELL_HELP_MENU": "Help",
    "SHELL_PROJECT_DOCK": "Project & Artifacts",
    "SHELL_INSPECTOR_DOCK": "Inspector",
    "SHELL_JOBS_DOCK": "Jobs, progress and logs",
    "SHELL_RESET_LAYOUT": "Reset workspace layout",
    "SHELL_DIAGNOSTICS": "Diagnostics",
    "SHELL_PROJECT": "Project",
    "SHELL_NO_PROJECT": "No project selected",
    "SHELL_CHOOSE_PROJECT": "Choose or import a scene to inspect its artifacts.",
    "SHELL_REFRESH": "Refresh",
    "SHELL_OPEN_SELECTED": "Open selected location",
    "SHELL_PROJECT_FILES": "Project files",
    "SHELL_IMAGES": "Images",
    "SHELL_MASKS": "Masks",
    "SHELL_OUTPUT": "Output",
    "SHELL_EMPTY": "empty",
    "SHELL_SFM_ARTIFACTS": "SfM artifacts",
    "SHELL_DATASET_ARTIFACTS": "Dataset artifacts",
    "SHELL_JOBS": "Jobs",
    "SHELL_INSPECTOR": "Inspector",
    "SHELL_ACTIVE_PROJECT": "Active project",
    "SHELL_PRIMARY_ACTION": "Primary action",
    "SHELL_SELECT_PROJECT": "Select a project",
    "SHELL_NO_ACTION": "No action available",
    "SHELL_LAYOUT_HINT": "Panel sizes and visibility are restored when 360GS Studio starts.",
    "SHELL_LANGUAGE_MENU": "Language",
    "SHELL_LANGUAGE_ENGLISH": "English",
    "SHELL_LANGUAGE_JAPANESE": "日本語",
    "SHELL_LANGUAGE_PERSIAN": "فارسی",
    "SHELL_LANGUAGE_RESTART_TITLE": "Language saved",
    "SHELL_LANGUAGE_RESTART_BODY": "The selected language will be applied the next time the application starts.",
    "PERSPECTIVE_TITLE": "Perspective Export",
    "PERSPECTIVE_INPUT_MEDIA": "Input media or image folder",
    "PERSPECTIVE_OUTPUT_FOLDER": "Output folder",
    "PERSPECTIVE_CHOOSE_IMAGE_FOLDER": "Choose an image-sequence folder",
    "PERSPECTIVE_FORMAT_PNG": "PNG sequence",
    "PERSPECTIVE_FORMAT_JPEG": "JPEG sequence",
    "PERSPECTIVE_FORMAT_HEVC": "H.265 / HEVC video",
    "PERSPECTIVE_FORMAT": "Format",
    "PERSPECTIVE_INTERVAL": "Interval",
    "PERSPECTIVE_BATCH": "Batch",
    "PERSPECTIVE_COLMAP_RIG": "COLMAP rig",
    "PERSPECTIVE_REPLACE_EXPORT": "Replace existing export",
    "PERSPECTIVE_CUBEMAP": "Cubemap",
    "PERSPECTIVE_RING": "8-view ring",
    "PERSPECTIVE_ADD_VIEW": "Add view",
    "PERSPECTIVE_REMOVE_VIEW": "Remove view",
    "PERSPECTIVE_SAVE_PROFILE": "Save profile",
    "PERSPECTIVE_LOAD_PROFILE": "Load profile",
    "PERSPECTIVE_REFRESH_PREVIEW": "Refresh preview",
    "PERSPECTIVE_RESTORE_JOB": "Restore interrupted export",
    "PERSPECTIVE_PREVIEW_PROMPT": "Choose an image, image folder, or video to preview the selected view.",
    "PERSPECTIVE_PREVIEW_UNAVAILABLE": "Preview unavailable for this source.",
    "PERSPECTIVE_PROJECT_READY": "Project metadata ready. Migrated legacy scene: {migrated}; recovered jobs: {recovered}.",
    "PERSPECTIVE_PROJECT_WARNING": "Project metadata warning: {error}",
    "PERSPECTIVE_EXPORT_ACTION": "Export Perspective Views",
    "PERSPECTIVE_EXPORT_TOOLTIP": "Export all enabled views with a bounded shared decode pipeline.",
    "PERSPECTIVE_VIEW_NAME": "View {index}",
    "PERSPECTIVE_INVALID_VIEW": "Invalid view: {error}",
    "PERSPECTIVE_INVALID_PROFILE": "Invalid profile",
    "PERSPECTIVE_JOB_RESTORED": "Interrupted export settings restored. Run the export to resume safely.",
    "PERSPECTIVE_UNKNOWN": "unknown",
    "PERSPECTIVE_UNKNOWN_STORAGE": "unknown storage",
    "PERSPECTIVE_UNKNOWN_TIME": "unknown time",
    "PERSPECTIVE_ESTIMATE": "{views} enabled view(s) · {outputs} output item(s) · about {storage} · about {time} · {megapixels} MP/source frame · {batches} shared decode batch(es). Right-click a globe marker to enable or disable it; drag empty globe space to orbit.",
    "PERSPECTIVE_COLUMN_ON": "On",
    "PERSPECTIVE_COLUMN_NAME": "Name",
    "PERSPECTIVE_COLUMN_YAW": "Yaw",
    "PERSPECTIVE_COLUMN_PITCH": "Pitch",
    "PERSPECTIVE_COLUMN_ROLL": "Roll",
    "PERSPECTIVE_COLUMN_HFOV": "H-FOV",
    "PERSPECTIVE_COLUMN_VFOV": "V-FOV",
    "PERSPECTIVE_COLUMN_WIDTH": "Width",
    "PERSPECTIVE_COLUMN_HEIGHT": "Height",
    "PERSPECTIVE_COLUMN_INTERPOLATION": "Interpolation",
    # Common
    "BROWSE": "Browse...",
