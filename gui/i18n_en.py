...
STRINGS: dict[str, str] = {
    ...
    "DATASET_MASK_MODE": "Training Masks",
    "DATASET_MASK_MODE_CONVERT_SFM": "Convert SfM",
    "DATASET_MASK_MODE_GENERATE_TRAINING": "Regenerate",
    "DATASET_MASK_MODE_REUSE_EXISTING": "Use Existing",
    "DATASET_MASK_MODE_NONE": "None",
    ...
    "DATASET_TOOL_METASHAPE_DESC": "Create profile-specific transforms_[profile].json and pointcloud_[profile].ply files from a Metashape camera XML and point-cloud PLY. Choose PINHOLE or ERP 360° in the Output tab.",
...
TIPS: dict[str, str] = {
    ...
    "DATASET_MASK_MODE": "Choose how masks are written into the dataset output. This separates broad SfM masks from masks regenerated for training.",
    "DATASET_MASK_MODE_CONVERT_SFM_MASKS": "Convert Step 3 SfM masks from masks/ into the dataset output masks/. This preserves the compatible behavior for broad SfM exclusion masks.",
    "DATASET_MASK_MODE_GENERATE_TRAINING": "Regenerate masks against the dataset output images/. Use this when SfM used broad masks but training should keep only people or other training-specific targets masked.",
    "DATASET_MASK_MODE_REUSE_EXISTING": "Keep the existing masks/ in the dataset output and update mask_path entries in the transforms JSON to match them.",
    "DATASET_MASK_MODE_NONE": "Remove mask_path entries from the dataset transforms JSON. Existing masks/ files are left on disk.",
