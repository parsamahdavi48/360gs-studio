...
STRINGS: dict[str, str] = {
    ...
    "SFM_REALITYSCAN_DETAIL_DESC": "Create Cubemap images and XMP files for RealityScan from a Metashape SfM result. Registered scene images that are not in the Metashape XML are bundled in the same import folder as unposed extra images.",
    # Step 5
...
TIPS: dict[str, str] = {
    ...
    "SFM_ROUTE_REALITYSCAN": "Images in the Metashape XML are converted to Cubemap views with XMP poses. Registered images missing from the XML are bundled as unposed extra RealityScan inputs.",
    ...
    "TARGET_PROFILE_REALITYSCAN": "Creates RealityScan-ready cubemap images and XMP camera poses from a Metashape SfM result. Registered images missing from the XML are bundled as unposed extra inputs for RealityScan Align.",
