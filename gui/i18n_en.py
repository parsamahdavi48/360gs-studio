...
STRINGS: dict[str, str] = {
    ...
    "DATASET_MASK_REBUILD_ALL": "Overwrite every existing training mask",
...
TIPS: dict[str, str] = {
    ...
    "DATASET_MASK_REBUILD_SCOPE": "When off, training masks that need rebuilding are still regenerated. When on, every existing mask is overwritten, including unchanged masks.",
    "DATASET_MASK_REBUILD_ALL": "When off, training masks that need rebuilding are still regenerated. When on, every existing mask is overwritten, including unchanged masks.",
