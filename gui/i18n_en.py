...
STRINGS: dict[str, str] = {
    ...
    "DATASET_MASK_REBUILD_SCOPE": "Rebuild Scope",
    "DATASET_MASK_REBUILD_ALL": "Rebuild All",
...
TIPS: dict[str, str] = {
    ...
    "DATASET_MASK_REBUILD_SCOPE": "Normally only training masks that are missing or affected by changed mask settings are rebuilt automatically. Turn this on only when every existing training mask should be overwritten.",
    "DATASET_MASK_REBUILD_ALL": "Overwrite and rebuild all Step 5 training masks with the current mask settings.",
