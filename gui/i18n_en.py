...
STRINGS: dict[str, str] = {
    ...
    "SFM_MENU_DESC": "Choose how camera poses are produced. In-app SfM routes and external SfM imports are configured and run from the next dataset step.",
    "SFM_SELECT_ROUTE": "Choose Route",
    "SFM_ROUTE_EXTERNAL_TITLE": "Use External SfM Result",
    "SFM_ROUTE_EXTERNAL_BODY": "Create datasets from camera results prepared in Metashape or another SfM tool.",
    "SFM_ROUTE_EXTERNAL_FOOTER": "Input: XML / PLY",
    ...
    "DATASET_MENU_DESC": "Run the conversions and corrections needed before training, using SfM results, external tool exports, or existing datasets.",
    "DATASET_SELECT_TOOL": "Choose Tool",
    "DATASET_BACK_TO_MENU": "← Dataset Menu",
    "DATASET_TOOL_CUBEMAP_TITLE": "SfM Result → Dataset",
    "DATASET_TOOL_CUBEMAP_CARD_BODY": "Create Cubemap, 3DGUT, and Postshot/Brush/LichtFeld outputs from Metashape, COLMAP, or SphereSfM results.",
    "DATASET_TOOL_CUBEMAP_CARD_FOOTER": "Input: SfM result / images / masks",
...
TIPS: dict[str, str] = {
    ...
    "SFM_SELECT_ROUTE": "Choose an SfM route from the cards, then configure and run it in the dataset step.",
    "SFM_ROUTE_EXTERNAL": "Use camera results already prepared in an external SfM tool. Metashape XML/PLY and related inputs are selected in the dataset step.",
    "SFM_ROUTE_COLMAP": "Prepare Cubemap images in this app and run COLMAP/GLOMAP. SfM execution and dataset creation are configured together in the dataset step.",
    "SFM_ROUTE_SPHERESFM": "Process 360 images with the SphereSfM COLMAP build. The dataset step controls SfM-only or SfM plus dataset conversion runs.",
    "DATASET_SELECT_TOOL": "Choose the dataset creation or correction tool from the cards.",
    "DATASET_TOOL_CUBEMAP": "The existing Metashape/COLMAP/SphereSfM workflow. Use it for SfM inputs, Cubemap/3DGUT outputs, and COLMAP/GLOMAP execution.",
