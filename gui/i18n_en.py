...
STRINGS: dict[str, str] = {
    ...
    "SFM_REALITYSCAN_DETAIL_DESC": "Create Cubemap images and XMP files for RealityScan from a Metashape SfM result. Images in the Metashape XML go to images; registered images missing from the XML go to extra_images for a later import.",
    # Step 5
...
TIPS: dict[str, str] = {
    ...
    "SFM_ROUTE_REALITYSCAN": "Images in the Metashape XML are converted to Cubemap views with XMP poses. Registered images missing from the XML are separated into extra_images for later import.",
    ...
    "RS_LFS_IMAGES": "Source image folder matching the image names in the CSV. Usually output/realityscan/images/. If extra_images/ exists beside it, extra images are found automatically.",
    ...
    "TARGET_PROFILE_REALITYSCAN": "Creates RealityScan-ready cubemap images and XMP camera poses from a Metashape SfM result. Registered images missing from the XML are written separately to extra_images for later import.",
