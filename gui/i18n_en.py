...
STRINGS: dict[str, str] = {
    ...
    "SFM_ROUTE_REALITYSCAN_TITLE": "Create RealityScan Data",
    "SFM_ROUTE_REALITYSCAN_BODY": "Create Cubemap images and XMP files for realignment in RealityScan from existing Metashape 360 camera results.",
    "SFM_ROUTE_REALITYSCAN_FOOTER": "Output: output/realityscan/",
    "SFM_ROUTE_COLMAP_TITLE": "Run COLMAP SfM",
    "SFM_ROUTE_COLMAP_BODY": "Launch COLMAP or GLOMAP from this app and prepare the required Cubemap view images.",
    "SFM_ROUTE_COLMAP_FOOTER": "Output: output/colmap_rig/",
    "SFM_ROUTE_SPHERESFM_TITLE": "Run SphereSfM",
    "SFM_ROUTE_SPHERESFM_BODY": "Launch the SphereSfM COLMAP build from this app and create a sparse model from 360 images.",
    ...
    "SFM_REALITYSCAN_DETAIL_TITLE": "Create RealityScan Data",
    "SFM_REALITYSCAN_DETAIL_DESC": "Create Cubemap images and XMP files for RealityScan from Metashape XML plus source images and masks. Import output/realityscan/ into RealityScan, then export CSV/PLY after Align.",
    # Step 5
    "DATASET_MENU_TITLE": "Training Dataset Creation",
    "DATASET_MENU_DESC": "Choose the type of SfM result or existing dataset. Select the target app or output format, such as Postshot, Brush, LichtFeld, or GUT, after opening a card.",
    "DATASET_SELECT_TOOL": "Choose Tool",
    "DATASET_BACK_TO_MENU": "← Dataset Menu",
    "DATASET_TOOL_METASHAPE_TITLE": "Metashape Result → Cubemap / GUT",
    ...
    "DATASET_TOOL_METASHAPE_CARD_BODY": "Convert camera results prepared in Metashape into Cubemap or GUT training data.",
    "DATASET_TOOL_METASHAPE_CARD_FOOTER": "Input: XML / PLY / images / masks",
    "DATASET_TOOL_SPHERESFM_TITLE": "SphereSfM Result → Cubemap / GUT",
    "DATASET_TOOL_SPHERESFM_DESC": "Create Cubemap or GUT training data from the SphereSfM sparse model made in Step 4, or from another selected SphereSfM sparse model.",
    "DATASET_TOOL_SPHERESFM_CARD_BODY": "Convert a SphereSfM sparse model into Cubemap or GUT data.",
...
TIPS: dict[str, str] = {
    ...
    "SFM_RUN_REALITYSCAN": "Create Cubemap images and XMP files for RealityScan realignment from Metashape XML.",
    ...
    "SFM_ROUTE_REALITYSCAN": "Prepare images and XMP files so Metashape SfM results can be imported into RealityScan for realignment.",
    "SFM_ROUTE_COLMAP": "Launch COLMAP/GLOMAP from this app. The required Cubemap view images are prepared in the same run.",
    "SFM_ROUTE_SPHERESFM": "Launch the SphereSfM COLMAP build from this app. Conversion to a training dataset is handled in Step 5.",
    ...
    "DATASET_TOOL_METASHAPE": "Use Metashape XML/PLY as the input and create Cubemap or GUT training data.",
    "DATASET_TOOL_SPHERESFM": "Use a SphereSfM sparse model as the input and create Cubemap or GUT training data. Run SfM itself in Step 4.",
