...
class Step4TrainingSettingsRestoreMixin:
    ...
    def _restore_lfs_settings(self, payload: object) -> None:
        ...
        state = {
            ...
            "depth_loss": payload.get("depth_loss", False),
            "depth_loss_mode": payload.get("depth_loss_mode", "adaptive-warped-l1"),
            "depth_loss_weight": payload.get("depth_loss_weight", self.lfs_depth_loss_weight_edit.text()),
