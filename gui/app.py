...
class MainWindow(QWidget):
    ...
    def _build_ui(self, initial_scene_dir: str) -> None:
        ...
        self.scene_browse.setToolTip("作業対象のシーンフォルダ。images/, masks/ などのサブフォルダが自動認識されます")
