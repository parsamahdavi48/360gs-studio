...
STRINGS: dict[str, str] = {
    ...
    "SFM_REALITYSCAN_DETAIL_DESC": "MetashapeのSfM結果からRealityScanに渡すCubemap画像とXMPを作成します。Metashape XMLにある画像はimagesへ、XMLにない登録済み画像は後から追加するextra_imagesへ分けて出力します。",
    # Step 5
...
TIPS: dict[str, str] = {
    ...
    "SFM_ROUTE_REALITYSCAN": "Metashape XMLにある画像はCubemap化してXMP姿勢を書き出し、XMLにない登録済み画像は後から追加するextra_imagesとして分けます",
    ...
    "RS_LFS_IMAGES": "CSV内の画像名に対応する元画像フォルダです。通常は output/realityscan/images/ を使います。同じ階層に extra_images/ があれば追加画像も自動で探します",
