...
STRINGS: dict[str, str] = {
    ...
    "SFM_REALITYSCAN_DETAIL_DESC": "MetashapeのSfM結果からRealityScanに渡すCubemap画像とXMPを作成します。ステップ1から3で登録済みの画像のうち、Metashape XMLにないものは姿勢なしの追加画像として同じ投入フォルダにまとめます。",
    # Step 5
...
TIPS: dict[str, str] = {
    ...
    "SFM_ROUTE_REALITYSCAN": "Metashape XMLにある画像はCubemap化してXMP姿勢を書き出し、XMLにない登録済み画像は姿勢なしの追加画像としてRealityScan投入用にまとめます",
