...
STRINGS: dict[str, str] = {
    ...
    "REVIEW_RENUMBER_BLOCKED": "マスクまたはStep 4の成果物があるため、連番化はできません。",
    ...
    "SCENE_PREVIEW_NO_CANDIDATES": "読み込めるSfM結果またはStep 4出力が見つかりません。",
...
TIPS: dict[str, str] = {
    ...
    "REVIEW_RENUMBER_KEPT_IMAGES": "適用時に採用画像をCSV順で images/frame_000001.ext からの連番にリネームします。マスク生成前、Step 4出力前の整理用です",
    ...
    "SCENE_PREVIEW_OPEN": "SfM結果またはStep 4出力を読み取り専用で開き、カメラ・点群・画像対応を確認します。",
    "SCENE_PREVIEW_SELECT_SCENE": "読み取り専用プレビューで確認するシーンフォルダを選びます",
    "SCENE_PREVIEW_REFRESH": "シーンフォルダ内のSfM結果とStep 4出力を再検出します",
