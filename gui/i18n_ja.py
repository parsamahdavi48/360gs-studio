...
STRINGS: dict[str, str] = {
    ...
    "SFM_ROUTE_REALITYSCAN_TITLE": "RealityScan用データ作成",
    "SFM_ROUTE_REALITYSCAN_BODY": "Metashapeで作成済みの360カメラ結果から、RealityScanで再アラインするためのCubemap画像とXMPを作成します。",
    "SFM_ROUTE_REALITYSCAN_FOOTER": "出力: output/realityscan/",
    "SFM_ROUTE_COLMAP_TITLE": "COLMAPでSfMを実行",
    "SFM_ROUTE_COLMAP_BODY": "このアプリからCOLMAPまたはGLOMAPを起動し、必要なCubemap視点画像も準備します。",
    "SFM_ROUTE_COLMAP_FOOTER": "出力: output/colmap_rig/",
    "SFM_ROUTE_SPHERESFM_TITLE": "SphereSfMでSfMを実行",
    "SFM_ROUTE_SPHERESFM_BODY": "このアプリからSphereSfM版COLMAPを起動し、360画像からsparseモデルを作成します。",
    ...
    "SFM_REALITYSCAN_DETAIL_TITLE": "RealityScan用データ作成",
    "SFM_REALITYSCAN_DETAIL_DESC": "MetashapeのXMLと元画像・マスクから、RealityScanに渡すCubemap画像とXMPを作成します。ここで作った output/realityscan/ をRealityScanへ読み込み、Align後にCSV/PLYを書き出します。",
    # Step 5
    "DATASET_MENU_TITLE": "学習用データセット作成",
    "DATASET_MENU_DESC": "SfM結果または既存データの種類を選びます。Postshot / Brush / LichtFeld / GUT などの出力先は、カードを開いた先で指定します。",
    "DATASET_SELECT_TOOL": "ツールを選択",
    "DATASET_BACK_TO_MENU": "← データセット一覧",
    "DATASET_TOOL_METASHAPE_TITLE": "Metashape結果 → Cubemap / GUT",
    "DATASET_TOOL_METASHAPE_DESC": "MetashapeのXML/PLYと元画像・マスクから、Postshot / Brush / LichtFeld向けの学習用データセットを作成します。",
    "DATASET_TOOL_METASHAPE_CARD_BODY": "Metashapeで作成済みのカメラ結果を、学習用のCubemapまたはGUT用データへ変換します。",
    "DATASET_TOOL_METASHAPE_CARD_FOOTER": "入力: XML / PLY / images / masks",
    "DATASET_TOOL_SPHERESFM_TITLE": "SphereSfM結果 → Cubemap / GUT",
    "DATASET_TOOL_SPHERESFM_DESC": "Step 4で作成したSphereSfM sparseモデル、または指定したSphereSfM sparseモデルから、CubemapまたはGUT用データセットを作成します。",
    "DATASET_TOOL_SPHERESFM_CARD_BODY": "SphereSfMのsparseモデルを、CubemapまたはGUT用データへ変換します。",
...
TIPS: dict[str, str] = {
    ...
    "SFM_RUN_REALITYSCAN": "Metashape XMLからRealityScan再アライン用のCubemap画像とXMPを作成します",
    ...
    "SFM_ROUTE_REALITYSCAN": "MetashapeのSfM結果をRealityScanに持ち込み、RealityScan側で再アラインするための画像とXMPを作成します",
    "SFM_ROUTE_COLMAP": "このアプリからCOLMAP/GLOMAPをCLI起動してSfMするルートです。必要なCubemap視点画像もこの実行で準備します",
    "SFM_ROUTE_SPHERESFM": "このアプリからSphereSfM版COLMAPをCLI起動してSfMするルートです。学習用データセットへの変換はStep 5で行います",
    "SFM_ROUTE_VIEWER": "作成済みのカメラ位置、点群、transforms.jsonの整合を確認するビューを開きます",
    "DATASET_SELECT_TOOL": "カードから作成または補正したいデータセット処理を選びます",
    "DATASET_TOOL_METASHAPE": "Metashapeで作成済みのXML/PLYを入力にして、CubemapまたはGUT用の学習データセットを作ります",
    "DATASET_TOOL_SPHERESFM": "SphereSfMのsparseモデルを入力にして、CubemapまたはGUT用の学習データセットを作ります。SfM自体の実行はStep 4で行います",
