...
_JA: dict[str, str] = {
    ...
    "YOLO_LEVEL_QUALITY": "2 高品質・360°推奨",
    "YOLO_LEVEL_BEST": "3 最高・重い",
    "YOLO_EXPAND": "マスク拡張 (px)",
    "YOLO_EXPAND_COMPACT": "拡張",
    "YOLO_BOTTOM_ENHANCE": "下部検出強化",
    "YOLO_BOTTOM_STANDARD": "標準",
    "YOLO_BOTTOM_STRONG": "下部漏れ対策",
    "YOLO_BOTTOM_MAX": "下部漏れ対策・強",
    "YOLO_ADD_EXT": "拡張子を付加",
    "YOLO_CLASSES": "検出クラス",
...
_EN: dict[str, str] = {
    ...
    "YOLO_LEVEL_QUALITY": "2 Quality (360°)",
    "YOLO_LEVEL_BEST": "3 Best (Heavy)",
    "YOLO_EXPAND": "Mask Expand (px)",
    "YOLO_EXPAND_COMPACT": "Expand",
    "YOLO_BOTTOM_ENHANCE": "Bottom Enhance",
    "YOLO_BOTTOM_STANDARD": "Standard",
    "YOLO_BOTTOM_STRONG": "Bottom Leak Fix",
    "YOLO_BOTTOM_MAX": "Bottom Leak Fix+",
...
_TIPS_JA: dict[str, str] = {
    ...
    "YOLO_BOTTOM_ENHANCE": "360°画像の真下付近に写る撮影者・三脚・手元の検出漏れを減らします。下部が十分にマスクされているなら「標準」。真上から見た撮影者が漏れる場合は「下部漏れ対策」。それでも漏れる場合だけ「下部漏れ対策・強」を使います。強くするほど処理時間が増え、床や地面を余分にマスクする場合があります",
...
_TIPS_EN: dict[str, str] = {
    ...
    "YOLO_BOTTOM_ENHANCE": "Reduces missed masks near the bottom of 360° images, such as top-down photographers, tripods, and hands. Use Standard when the bottom is already masked well. Use Bottom Leak Fix when top-down photographers remain. Use Bottom Leak Fix+ only if they still remain. Stronger settings take longer and can mask extra floor or ground",
