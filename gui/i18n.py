...
_TIPS_JA: dict[str, str] = {
    ...
    "PITCH_ROWS": "垂直方向のPitch角をカンマ区切りで指定 (度)。-90〜90、最大5行。標準は -45,0,45",
...
_TIPS_EN: dict[str, str] = {
    ...
    "PITCH_ROWS": "Vertical pitch angles, comma-separated (degrees). -90 to 90, max 5 rows. Standard: -45,0,45",
