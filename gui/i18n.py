...
_JA: dict[str, str] = {
    ...
    "ADE20K_CLASS_LIST_SECTION": "ADE20Kクラス一覧",
    ...
    "MASK_REPROCESS_SELECTED_FALLBACK_BUTTON": "選択画像を再生成",
...
_EN: dict[str, str] = {
    ...
    "ADE20K_CLASS_LIST_SECTION": "ADE20K Class List",
    ...
    "MASK_REPROCESS_SELECTED_FALLBACK_BUTTON": "Regenerate Selected",
...
_TIPS_JA: dict[str, str] = {
    ...
    "SAM31_CUSTOM_PROMPT": "SAM3.1へ追加で投げる英語プロンプト。カンマ区切りで複数指定できます",
...
_TIPS_EN: dict[str, str] = {
    ...
    "SAM31_CUSTOM_PROMPT": "Additional English prompts for SAM3.1. Separate multiple prompts with commas",
