...
_JA: dict[str, str] = {
    ...
    "OUTPUT_SHAPE_EQUIRECT_3DGUT": "元の360画像 (LichtFeld 3DGUT)",
    "OUTPUT_SHAPE_EQUIRECT_HINT": "元の360画像と masks/ をそのまま使い、LichtFeld 3DGUT向けの transforms.json と pointcloud.ply を作成します。",
    "AXIS_TRANSFORM": "座標変換",
...
_EN: dict[str, str] = {
    ...
    "OUTPUT_SHAPE_EQUIRECT_3DGUT": "Use Source 360 Images (LichtFeld 3DGUT)",
    "OUTPUT_SHAPE_EQUIRECT_HINT": "Uses the source 360 images and masks/ directly, and writes transforms.json plus pointcloud.ply for LichtFeld 3DGUT.",
