...
_JA: dict[str, str] = {
    ...
    "SPHERESFM_FEATURE_COMPACT": "Feature:",
    "SPHERESFM_FEATURE_FAST": "Fast",
    "SPHERESFM_FEATURE_STANDARD": "Standard",
    "SPHERESFM_FEATURE_ROBUST": "Robust",
...
_TIPS_JA: dict[str, str] = {
    ...
    "OUTPUT_DIR_SPHERESFM_PROJECT": "シーンフォルダ内の output/spheresfm/ にSphereSfMのdatabase、マスク変換結果、sparseモデル、3DGUTまたは投影視点データを作成します",
    ...
    "METHOD_SPHERESFM": "抽出済みのエクイレクタングラー画像をSphereSfM版COLMAPへ直接渡して球面SfMを実行します",
    ...
    "SPHERESFM_FEATURE_PRESET": "SIFT特徴量の上限。Fastは軽量、Standardは既定、Robustは重い代わりに特徴点を多く残します",
...
_TIPS_EN: dict[str, str] = {
    ...
    "OUTPUT_DIR_SPHERESFM_PROJECT": "Creates the SphereSfM database, converted masks, sparse model, and either 3DGUT or projected-view output under output/spheresfm/ inside the scene folder.",
    ...
    "METHOD_SPHERESFM": "Run spherical SfM directly on extracted equirectangular images using SphereSfM's COLMAP build.",
    ...
    "SPHERESFM_FEATURE_PRESET": "SIFT feature budget. Fast is lighter, Standard is the default, and Robust keeps more features at higher cost.",
