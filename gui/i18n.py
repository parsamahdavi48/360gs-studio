...
_JA: dict[str, str] = {
    ...
    "NEXT_STEP_MASK_NOTICE": "確認と採用/除外の調整が終わったら、下部の「適用」を押して選別結果を画像フォルダへ反映します。\n適用後に Step 3 (マスク生成) へ進みます。",
...
_EN: dict[str, str] = {
    ...
    "NEXT_STEP_MASK_NOTICE": "After reviewing keep/drop choices, press Apply at the bottom to write the selection into the image folder.\nThen proceed to Step 3 (Mask Generation).",
