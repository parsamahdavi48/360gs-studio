...
_EN: dict[str, str] = {
    ...
    "YOLO_BOTTOM_STRONG": "Fix",
    "YOLO_BOTTOM_MAX": "Strong",
...
_TIPS_JA: dict[str, str] = {
    ...
    "YOLO_BOTTOM_ENHANCE": "360°画像の真下付近に写る撮影者・三脚・手元の検出漏れを減らします。下部が十分にマスクされているなら「標準」。真上から見た撮影者が漏れる場合は「対策」。それでも漏れる場合だけ「強」を使います。強くするほど処理時間が増え、床や地面を余分にマスクする場合があります",
...
_TIPS_EN: dict[str, str] = {
    ...
    "YOLO_BOTTOM_ENHANCE": "Reduces missed masks near the bottom of 360° images, such as top-down photographers, tripods, and hands. Use Standard when the bottom is already masked well. Use Fix when top-down photographers remain. Use Strong only if they still remain. Stronger settings take longer and can mask extra floor or ground",
