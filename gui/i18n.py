...
_TIPS_JA: dict[str, str] = {
    ...
    "PREVIEW_PROJECTION_TOGGLE": "FOV 90°の正方形パース表示に切り替えます。パース表示中はドラッグで視線方向を回し、ホイールで表示中画像を2Dズームします",
...
_TIPS_EN: dict[str, str] = {
    ...
    "PREVIEW_PROJECTION_TOGGLE": "Switch to a square 90° FOV perspective view. In perspective view, drag to look around and use the wheel for 2D zoom on the displayed image",
