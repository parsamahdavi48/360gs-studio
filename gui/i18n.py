...
_TIPS_JA: dict[str, str] = {
    ...
    "OUTPUT_DIR_CUBEMAP": "シーンフォルダ内の output/ を自動使用します。既存ファイルがある場合は確認後にリセットしてから書き出します",
...
_TIPS_EN: dict[str, str] = {
    ...
    "OUTPUT_DIR_CUBEMAP": "Automatically uses output/ inside the scene folder. If files already exist, it asks before resetting the folder.",
