...
_TIPS_JA: dict[str, str] = {
    ...
    "OUTPUT_DIR_SPHERESFM_PROJECT": "シーンフォルダ内の output/spheresfm/ にSphereSfMのdatabase、マスク変換結果、sparseモデルを作成します",
...
_TIPS_EN: dict[str, str] = {
    ...
    "OUTPUT_DIR_SPHERESFM_PROJECT": "Creates the SphereSfM database, converted masks, and sparse model under output/spheresfm/ inside the scene folder.",
