...
_TIPS_JA: dict[str, str] = {
    ...
    "SPHERESFM_OUTPUT_SHAPE": "SphereSfMのSfM結果を、3DGUT用データにするか、投影視点データにするかを選びます",
...
_TIPS_EN: dict[str, str] = {
    ...
    "SPHERESFM_OUTPUT_SHAPE": "Choose whether the SphereSfM SfM result becomes 3DGUT data or projected-view data.",
