...
_JA: dict[str, str] = {
    ...
    "METASHAPE_PLY": "点群PLY",
    "MS_XML_PLACEHOLDER": "MetashapeでエクスポートしたカメラXMLを選択",
    "MS_PLY_PLACEHOLDER": "点群PLYを使う場合はMetashapeでエクスポートしたPLYを選択",
    "MS_XML_MISSING_HINT": "カメラXMLは未選択です。シーン直下の {names} は自動認識します。",
    "MS_PLY_MISSING_HINT": "点群PLYは未選択です。シーン直下の {names} は自動認識します。",
    "MS_XML_MANUAL_SELECTION_HINT": "XML候補がありますが自動選択しません: {names}。今回使うカメラXMLを選択してください。",
    "MS_PLY_MANUAL_SELECTION_HINT": "PLY候補がありますが自動選択しません: {names}。今回使う点群PLYを選択してください。",
    "MS_XML_SELECTED_MISSING_HINT": "選択中のカメラXMLが見つかりません: {path}",
    "MS_PLY_SELECTED_MISSING_HINT": "選択中の点群PLYが見つかりません: {path}",
    "MS_PLY_ONLY_POINTCLOUD_HINT": "pointcloud.ply はこのアプリの変換後点群として扱うため、Metashape入力PLYには使いません。",
    "MS_INPUT_IN_OUTPUT_HINT": "Metashape入力は output/ の外に置いてください: {path}",
    ...
    "TRAINING_BACKEND_CUSTOM_SHORT": "Custom",
    ...
    "STEP4_PIPELINE_INTENT_METASHAPE_INPUT": "Cubeに必要なMetashape入力です。SfM実行コマンドはありません。クリックするとSfM設定を表示します。",
    ...
    "STEP4_PIPELINE_NAVIGATE": "クリックすると、{stage}の設定を表示します。",
    "STEP4_PIPELINE_DETAIL_SCENE_REQUIRED": "シーンフォルダを選択すると状態を確認できます。",
    "STEP4_PIPELINE_DETAIL_METASHAPE_OFF": "CubeがOFFなので、今回はMetashape入力を使いません。CubeをONにすると確認します。",
    "STEP4_PIPELINE_DETAIL_METASHAPE_READY": "Metashape入力を使えます。CubeをONにするとCubemapまたは3DGUT用データを作成できます。",
    ...
    "STEP4_PIPELINE_DETAIL_COLMAP_OFF": "今回はCOLMAP SfMを実行しません。必要なら左の丸をクリックしてください。",
    "STEP4_PIPELINE_DETAIL_COLMAP_NEEDS_RIG": "COLMAP SfMにはCube出力が必要です。Cubeも実行対象にするか、既存のCOLMAP Rig出力を用意してください。",
    "STEP4_PIPELINE_DETAIL_COLMAP_NEEDS_POSES": "COLMAP SfMを実行するか、既存のsparseモデルを用意してください。",
    "STEP4_PIPELINE_DETAIL_SPHERESFM_RUNS": "SphereSfMをこの実行で行います。",
    "STEP4_PIPELINE_DETAIL_SPHERESFM_READY": "既存のSphereSfM sparseモデルを使えます。",
    "STEP4_PIPELINE_DETAIL_SPHERESFM_OFF": "今回はSphereSfMを実行しません。必要なら左の丸をクリックしてください。",
    "STEP4_PIPELINE_DETAIL_SPHERESFM_NEEDS_SPARSE": "変換のみの場合は既存のsparseモデルが必要です。",
    "STEP4_PIPELINE_DETAIL_CONVERSION_RUNS": "投影Cubemapまたは3DGUT用データを作成します。",
    "STEP4_PIPELINE_DETAIL_CONVERSION_AFTER_SFM": "SfMも実行対象なので、その完了後にCubeを作成できます。",
    "STEP4_PIPELINE_DETAIL_CONVERSION_OFF": "今回はCubeを作成しません。必要なら左の丸をクリックしてください。",
    "STEP4_PIPELINE_DETAIL_TRAINING_OFF": "今回はトレーニングを実行しません。必要なら左の丸をクリックしてください。",
    "STEP4_PIPELINE_DETAIL_TRAINING_NEEDS_CONVERSION": "トレーニング用データがありません。Cubeを実行対象にするか、既存データセットを選択してください。",
    "STEP4_PIPELINE_DETAIL_TRAINING_RUNS": "{backend}をこの実行で起動します。",
...
_EN: dict[str, str] = {
    ...
    "MS_XML_PLACEHOLDER": "Select the camera XML exported from Metashape",
    "MS_PLY_PLACEHOLDER": "Select the PLY exported from Metashape when using a point cloud",
    "MS_XML_MISSING_HINT": "No camera XML is selected. Files named {names} at the scene root are auto-detected.",
    "MS_PLY_MISSING_HINT": "No point-cloud PLY is selected. Files named {names} at the scene root are auto-detected.",
    "MS_XML_MANUAL_SELECTION_HINT": "XML candidates exist but were not auto-selected: {names}. Select the camera XML for this run.",
    "MS_PLY_MANUAL_SELECTION_HINT": "PLY candidates exist but were not auto-selected: {names}. Select the point-cloud PLY for this run.",
    "MS_XML_SELECTED_MISSING_HINT": "The selected camera XML was not found: {path}",
    "MS_PLY_SELECTED_MISSING_HINT": "The selected point-cloud PLY was not found: {path}",
    "MS_PLY_ONLY_POINTCLOUD_HINT": "pointcloud.ply is treated as this app's converted point cloud, so it is not used as a Metashape input PLY.",
    "MS_INPUT_IN_OUTPUT_HINT": "Keep Metashape inputs outside output/: {path}",
    ...
    "STEP4_PIPELINE_INTENT_METASHAPE_INPUT": "Metashape input required by Cube. No SfM command is run. Click to show SfM settings.",
    ...
    "STEP4_PIPELINE_NAVIGATE": "Click to show {stage} settings.",
    "STEP4_PIPELINE_DETAIL_SCENE_REQUIRED": "Select a scene folder to check this stage.",
    "STEP4_PIPELINE_DETAIL_METASHAPE_OFF": "Cube is off, so Metashape input is not used in this run. Turn on Cube to check it.",
    "STEP4_PIPELINE_DETAIL_METASHAPE_READY": "Metashape input is available. Turn on Cube to create Cubemap or 3DGUT data.",
    ...
    "STEP4_PIPELINE_DETAIL_COLMAP_OFF": "COLMAP SfM will not run this time. Click the left circle if you need it.",
    "STEP4_PIPELINE_DETAIL_COLMAP_NEEDS_RIG": "COLMAP SfM needs Cube output. Enable Cube too, or provide an existing COLMAP Rig output.",
    "STEP4_PIPELINE_DETAIL_COLMAP_NEEDS_POSES": "Run COLMAP SfM or provide an existing sparse model.",
    "STEP4_PIPELINE_DETAIL_SPHERESFM_RUNS": "SphereSfM will run in this job.",
    "STEP4_PIPELINE_DETAIL_SPHERESFM_READY": "An existing SphereSfM sparse model is available.",
    "STEP4_PIPELINE_DETAIL_SPHERESFM_OFF": "SphereSfM will not run this time. Click the left circle if you need it.",
    "STEP4_PIPELINE_DETAIL_SPHERESFM_NEEDS_SPARSE": "Convert-only mode needs an existing sparse model.",
    "STEP4_PIPELINE_DETAIL_CONVERSION_RUNS": "Creates projected Cubemap data or 3DGUT data.",
    "STEP4_PIPELINE_DETAIL_CONVERSION_AFTER_SFM": "SfM is also selected, so Cube can be created after SfM finishes.",
    "STEP4_PIPELINE_DETAIL_CONVERSION_OFF": "Cube will not be created this time. Click the left circle if you need it.",
    "STEP4_PIPELINE_DETAIL_TRAINING_OFF": "Training will not run this time. Click the left circle if you need it.",
    "STEP4_PIPELINE_DETAIL_TRAINING_NEEDS_CONVERSION": "No training dataset is available. Enable Cube or select an existing dataset.",
    "STEP4_PIPELINE_DETAIL_TRAINING_RUNS": "Starts {backend} in this job.",
...
_TIPS_JA: dict[str, str] = {
    ...
    "MASK_IMAGE_TYPE": "Step 1または外部画像登録の情報から自動判定します。混在時は画像タイプ別に自動処理します",
    ...
    "TRAINING_BACKEND_OTHER": "追加の実行アプリを表示します。任意CLIはCustomで指定します",
    ...
    "MS_XML": "MetashapeからエクスポートしたカメラポーズXML。シーン直下の metashape.xml / cameras.xml は自動入力します。別名や複数候補がある場合は手動で選択してください",
    "MS_PLY": "Metashapeからエクスポートした点群PLY。シーン直下の metashape.ply / sparse.ply は自動入力します。pointcloud.ply はこのアプリの変換後点群として扱うため入力候補から除外します",
...
_TIPS_EN: dict[str, str] = {
    ...
    "TRAINING_BACKEND_OTHER": "Show additional training applications. Use Custom for arbitrary CLI commands.",
    ...
    "MS_XML": "Metashape-exported camera pose XML. The GUI auto-fills metashape.xml or cameras.xml at the scene root. Select the file manually when names differ or candidates are ambiguous.",
    "MS_PLY": "Metashape-exported point cloud PLY. The GUI auto-fills metashape.ply or sparse.ply at the scene root. pointcloud.ply is reserved for this app's converted point cloud and is excluded from input candidates.",
