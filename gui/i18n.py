...
_JA: dict[str, str] = {
    ...
    "STEP4_DESC": "SfM結果または抽出画像を3DGS用データセットへ変換",
    "STEP5_DESC": "作成済みデータセットを使って3DGSアプリを起動",
...
_EN: dict[str, str] = {
    ...
    "STEP4_DESC": "Convert SfM results or extracted frames into a 3DGS dataset",
    "STEP5_DESC": "Launch a 3DGS app with an existing dataset",
    "STEP1_TITLE": "1. Frame Extraction",
    "STEP2_TITLE": "2. Frame Review",
    "STEP3_TITLE": "3. Mask Generation",
    "STEP4_TITLE": "4. Convert",
    "STEP5_TITLE": "5. Training",
    "STEP1_NAV": "1\nExtract",
    "STEP2_NAV": "2\nReview",
    "STEP3_NAV": "3\nMask",
    "STEP4_NAV": "4\nConvert",
