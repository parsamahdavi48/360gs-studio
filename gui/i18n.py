...
_JA: dict[str, str] = {
    ...
    "TRAINING_BACKEND_OTHER_LABEL": "その他:",
    ...
    "STEP4_PIPELINE_DETAIL_METASHAPE_READY": "Metashape XMLを使って変換できます。",
    ...
    "STEP4_PIPELINE_DETAIL_CONVERSION_OFF": "SphereSfMのみ実行する設定のため、変換は行いません。",
    "STEP4_PIPELINE_DETAIL_TRAINING_OFF": "書き出し後のトレーニングは無効です。",
    "STEP4_PIPELINE_DETAIL_TRAINING_NEEDS_CONVERSION": "トレーニングにはSfM結果の変換が必要です。",
...
_EN: dict[str, str] = {
    ...
    "TRAINING_BACKEND_OTHER_LABEL": "Other:",
    ...
    "STEP4_PIPELINE_DETAIL_METASHAPE_READY": "The Metashape XML can be converted.",
    ...
    "STEP4_PIPELINE_DETAIL_CONVERSION_OFF": "Conversion is skipped because SphereSfM is set to SfM only.",
    "STEP4_PIPELINE_DETAIL_TRAINING_OFF": "Training after export is disabled.",
    "STEP4_PIPELINE_DETAIL_TRAINING_NEEDS_CONVERSION": "Training requires a converted SfM result.",
