...
_JA: dict[str, str] = {
    ...
    "STEP4_PIPELINE_DETAIL_METASHAPE_OFF": "今回はMetashape結果を使いません。必要なら左側をONにしてください。",
...
_EN: dict[str, str] = {
    ...
    "STEP4_PIPELINE_DETAIL_METASHAPE_OFF": "Metashape results are not used this time. Turn on the left control if you need them.",
