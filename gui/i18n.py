...
_JA: dict[str, str] = {
    ...
    "STEP4_PIPELINE_STATUS_PLANNED": "実行時に作成",
    "STEP4_PIPELINE_STATUS_PENDING": "未設定",
    "STEP4_PIPELINE_STATUS_WARNING": "要確認",
    "STEP4_PIPELINE_STATUS_OFF": "未使用",
    "STEP4_PIPELINE_STATUS_DISABLED": "対象外",
    "STEP4_PIPELINE_INTENT_ON": "クリックすると、{stage}を今回の実行から外します。",
    "STEP4_PIPELINE_INTENT_OFF": "クリックすると、{stage}を今回実行します。",
    ...
    "STEP4_PIPELINE_DETAIL_METASHAPE_READY": "Metashapeで作成したXMLを使います。Cubeを実行対象にすると変換できます。",
    ...
    "STEP4_PIPELINE_DETAIL_CONVERSION_RUNS": "選択したルートの結果から3DGS用データセットを作成します。",
...
_EN: dict[str, str] = {
    ...
    "STEP4_PIPELINE_STATUS_PLANNED": "Will run",
    "STEP4_PIPELINE_STATUS_PENDING": "Not set",
    "STEP4_PIPELINE_STATUS_WARNING": "Needs setup",
    "STEP4_PIPELINE_STATUS_OFF": "Off",
    "STEP4_PIPELINE_STATUS_DISABLED": "Not available",
    "STEP4_PIPELINE_INTENT_ON": "Click to remove {stage} from this run.",
    "STEP4_PIPELINE_INTENT_OFF": "Click to run {stage} this time.",
    ...
    "STEP4_PIPELINE_DETAIL_METASHAPE_READY": "Uses the XML created in Metashape. Enable Cube to convert it.",
    ...
    "STEP4_PIPELINE_DETAIL_CONVERSION_RUNS": "Creates the 3DGS dataset from the selected route output.",
