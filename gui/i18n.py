...
_TIPS_JA: dict[str, str] = {
    ...
    "EXTERNAL_IMAGES_SECTION": "画像フォルダ行の操作ボタンで、画像の追加とimages/の表示を行います",
    "EXTERNAL_IMAGES_ADD": "別の画像フォルダから対応画像をこのシーンの images/ にコピーします。画像タイプは上のボタンで選びます",
    ...
    "ADE20K_CLASS_LIST_SECTION": "Mask2FormerはADE20Kの既定クラスから検出対象を選び、その対象を検出してマスクします。人物、空、車など必要な対象だけ選びます",
...
_TIPS_EN: dict[str, str] = {
    ...
    "EXTERNAL_IMAGES_SECTION": "Use the image-folder row buttons to add images or open images/",
    "EXTERNAL_IMAGES_ADD": "Copy supported images from another folder into this scene's images/. Choose the image type with the buttons above",
    ...
    "ADE20K_CLASS_LIST_SECTION": "Mask2Former detects and masks selected targets from the built-in ADE20K class list. Choose only the targets you need, such as people, sky, or cars",
