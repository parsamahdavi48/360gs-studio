...
_JA: dict[str, str] = {
    ...
    "STEP4_PIPELINE_METASHAPE_CUBE_ENABLES_INPUT": "ONにすると変換に使うMetashape入力の確認もONになります。",
    "STEP4_PIPELINE_METASHAPE_CUBE_DISABLES_INPUT": "OFFにするとMetashape入力の確認もOFFになります。",
    "STEP4_PIPELINE_NOTICE_METASHAPE_ENABLED_INPUT": "変換に必要なため\nMetashape入力もONにしました",
    "STEP4_PIPELINE_NOTICE_METASHAPE_DISABLED_INPUT": "CubeをOFFにしたため\nMetashape入力もOFFにしました",
    ...
    "STEP4_PIPELINE_NOTICE_COLMAP_ENABLED_CUBE": "SfM用の視点画像が必要なため\nCubeもONにしました",
    "STEP4_PIPELINE_NOTICE_COLMAP_DISABLED_SFM": "視点画像を作らないため\nCOLMAP SfMもOFFにしました",
...
_EN: dict[str, str] = {
    ...
    "STEP4_PIPELINE_METASHAPE_CUBE_ENABLES_INPUT": "Turning this on also checks the Metashape input used for conversion.",
    "STEP4_PIPELINE_METASHAPE_CUBE_DISABLES_INPUT": "Turning this off also turns off the Metashape input check.",
    "STEP4_PIPELINE_NOTICE_METASHAPE_ENABLED_INPUT": "Metashape input is on\nfor conversion",
    "STEP4_PIPELINE_NOTICE_METASHAPE_DISABLED_INPUT": "Metashape input is off\nbecause Cube is off",
    ...
    "STEP4_PIPELINE_NOTICE_COLMAP_ENABLED_CUBE": "Cube is on to create\nSfM view images",
    "STEP4_PIPELINE_NOTICE_COLMAP_DISABLED_SFM": "COLMAP SfM is off\nwithout view images",
