...
_JA: dict[str, str] = {
    ...
    "MASK_READY_NO_IMAGES_DIR": "シーンフォルダ内に images/ がありません。Step 1 でフレーム抽出を実行してください。",
    "MASK_READY_NO_IMAGES": "images/ に対象画像がありません。Step 1 でフレーム抽出を実行してください。",
...
_EN: dict[str, str] = {
    ...
    "MASK_READY_NO_IMAGES_DIR": "images/ was not found in the scene folder. Run Step 1 frame extraction first.",
    "MASK_READY_NO_IMAGES": "No supported images were found in images/. Run Step 1 frame extraction first.",
...
_TIPS_JA: dict[str, str] = {
    ...
    "METHOD_COLMAP_EXPORT": "抽出済みのエクイレクタングラー画像とマスクから、COLMAPでSfMするための視点画像を書き出します。カメラポーズは作成しません",
    ...
    "YAW_OFFSET": "全ビューのYaw角にオフセットを加算 (度)。スティッチ線を避けるために45度推奨",
    "YAW_SLOTS": "水平方向の分割数 (4-8)。360度をN等分した角度でビューを配置",
    "PITCH_ROWS": "垂直方向のPitch角をカンマ区切りで指定 (度)。-90〜90。例: -30,0,30",
...
_TIPS_EN: dict[str, str] = {
    ...
    "METHOD_COLMAP_EXPORT": "Export viewpoint images and masks for COLMAP SfM from extracted equirectangular images. Camera poses are not created.",
