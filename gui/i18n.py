...
_TIPS_JA: dict[str, str] = {
    ...
    "METHOD_SPHERESFM": "抽出済みエクイレクタングラー画像をSphereSfMでSfMし、その結果から3DGUT用データまたはキューブマップデータを書き出します",
...
_TIPS_EN: dict[str, str] = {
    ...
    "METHOD_SPHERESFM": "Run SfM on extracted equirectangular images with SphereSfM, then export either 3DGUT data or cubemap data from the result.",
