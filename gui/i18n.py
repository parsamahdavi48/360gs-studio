...
_JA: dict[str, str] = {
    ...
    "STEP_HEADER_OUTPUT": "出力",
    "STEP_HEADER_TARGET": "対象",
    "STEP_HEADER_OUTPUT_ROOT": "出力ルート",
    ...
    "STEP4_PIPELINE_DETAIL_METASHAPE_READY": "Metashape入力を使えます。Cubemap変換をONにするとCubemapまたは3DGUT用データを作成できます。",
    ...
    "STEP4_PIPELINE_DETAIL_CONVERSION_OFF": "今回はCubemap変換を実行しません。必要なら左の丸をクリックしてください。",
    "STEP4_PIPELINE_DETAIL_TRAINING_OFF": "今回はトレーニングを実行しません。必要なら左の丸をクリックしてください。",
    "STEP4_PIPELINE_DETAIL_TRAINING_NEEDS_CONVERSION": "トレーニング用データがありません。Cubemap変換を実行対象にするか、既存データセットを選択してください。",
...
_EN: dict[str, str] = {
    ...
    "STEP_HEADER_OUTPUT": "Output",
    "STEP_HEADER_TARGET": "Target",
    "STEP_HEADER_OUTPUT_ROOT": "Output Root",
    ...
    "STEP4_PIPELINE_DETAIL_METASHAPE_READY": "Metashape input is available. Enable Cubemap conversion to create Cubemap or 3DGUT data.",
    ...
    "STEP4_PIPELINE_DETAIL_CONVERSION_OFF": "Cubemap conversion will not run this time. Click the left circle if you need it.",
    "STEP4_PIPELINE_DETAIL_TRAINING_OFF": "Training will not run this time. Click the left circle if you need it.",
    "STEP4_PIPELINE_DETAIL_TRAINING_NEEDS_CONVERSION": "No training dataset is available. Enable Cubemap conversion or select an existing dataset.",
