...
_JA: dict[str, str] = {
    ...
    "NEXT_STEP_MASK_NOTICE": "採用/除外を変更した場合だけ、下部の「適用」で画像フォルダへ反映します。\n変更していない場合はそのまま Step 3 (マスク生成) へ進めます。",
...
_EN: dict[str, str] = {
    ...
    "NEXT_STEP_MASK_NOTICE": "If you changed keep/drop choices, press Apply at the bottom to write them into the image folder.\nIf nothing changed, proceed directly to Step 3 (Mask Generation).",
