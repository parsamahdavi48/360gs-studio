...
_JA: dict[str, str] = {
    ...
    "STEP4_PIPELINE_COLMAP_SFM_ENABLES_CUBE": "COLMAP SfMにはCube出力が必要なため、ONにするとCubeもONになります。",
    "STEP4_PIPELINE_COLMAP_CUBE_DISABLES_SFM": "CubeをOFFにするとCOLMAP SfMもOFFになります。",
    "STEP4_PIPELINE_NOTICE_COLMAP_ENABLED_CUBE": "COLMAP SfMのため\nCubeもONにしました",
    "STEP4_PIPELINE_NOTICE_COLMAP_DISABLED_SFM": "CubeをOFFにしたため\nSfMもOFFにしました",
...
_EN: dict[str, str] = {
    ...
    "STEP4_PIPELINE_COLMAP_SFM_ENABLES_CUBE": "COLMAP SfM needs Cube output, so enabling SfM also enables Cube.",
    "STEP4_PIPELINE_COLMAP_CUBE_DISABLES_SFM": "Turning off Cube also turns off COLMAP SfM.",
    "STEP4_PIPELINE_NOTICE_COLMAP_ENABLED_CUBE": "Cube was turned on\nfor COLMAP SfM",
    "STEP4_PIPELINE_NOTICE_COLMAP_DISABLED_SFM": "SfM was turned off\nbecause Cube is off",
