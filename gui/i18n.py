...
_JA: dict[str, str] = {
    ...
    "STEP4_PIPELINE_INTENT_METASHAPE_INPUT": "Metashapeで作成したカメラポーズを入力として使います。SfM実行コマンドはありません。クリックするとSfM設定を表示します。",
...
_EN: dict[str, str] = {
    ...
    "STEP4_PIPELINE_INTENT_METASHAPE_INPUT": "Uses camera poses created in Metashape as input. No SfM command is run. Click to show SfM settings.",
