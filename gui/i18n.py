...
_JA: dict[str, str] = {
    ...
    "MS_XML_MISSING_HINT": "未選択。自動認識: {names}",
    "MS_PLY_MISSING_HINT": "未選択。自動認識: {names}",
...
_EN: dict[str, str] = {
    ...
    "MS_XML_MISSING_HINT": "Not selected. Auto-detects: {names}",
    "MS_PLY_MISSING_HINT": "Not selected. Auto-detects: {names}",
...
_TIPS_JA: dict[str, str] = {
    ...
    "MS_XML": "カメラポーズXML。シーン直下の metashape.xml / cameras.xml は自動入力します。別名は手動選択してください",
    "MS_PLY": "点群PLY。シーン直下の metashape.ply / sparse.ply は自動入力します。pointcloud.ply は入力候補から除外します",
...
_TIPS_EN: dict[str, str] = {
    ...
    "MS_XML": "Camera pose XML. Auto-fills metashape.xml or cameras.xml at the scene root. Select other names manually.",
    "MS_PLY": "Point-cloud PLY. Auto-fills metashape.ply or sparse.ply at the scene root. pointcloud.ply is excluded.",
