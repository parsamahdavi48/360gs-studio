...
def preflight_spheresfm(scene_or_inventory: str | Path | SceneInventory) -> SfmPreflightResult:
    ...
    if inventory.image_count <= 0:
        issues.append(
            PreflightIssue(
                "no_images",
                "SphereSfM requires equirectangular 360 images in images/.",
            )
        )
    ...
    if non_erp:
        ...
        issues.append(
            PreflightIssue(
                ...
                "SphereSfM supports only equirectangular 360 images. "
    ...
    if len(sizes) != 1:
        ...
        issues.append(
            PreflightIssue(
                ...
                "SphereSfM requires all source images to have the same resolution. "
