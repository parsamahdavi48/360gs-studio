...
parser.add_argument(
    ...
    type=int,
    metavar=("w", "h"),
    help="Output single mask file with the specified width & height (Ex:--single 7680 3840)",
)
parser.add_argument(
    "--fov", type=float, default=None, help="Field of View of fisheye lens (legacy, default=175.0 degrees)"
)
parser.add_argument(
    "--boundary-width",
    type=float,
    default=5.0,
    help="Total stitch boundary mask width in degrees (default=5.0, equivalent to --fov 175)",
)
