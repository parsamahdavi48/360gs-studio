...
def source_video_record(video_path: Path, video_info: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "video": {
            ...
            "avg_frame_rate": float(video_info.get("avg_frame_rate") or 0.0),
            "r_frame_rate": float(video_info.get("r_frame_rate") or 0.0),
            "variable_frame_rate": bool(video_info.get("variable_frame_rate")),
            "frame_rate_warning": str(video_info.get("frame_rate_warning") or ""),
