...
- 抽出フレームを単一プレビュー/サムネイル一覧で確認し、Windows Explorer式のサムネイル選択で採用/除外を整理。360°画像はFOV90°のパース表示でも確認できます
...
- 大量画像でも使いやすいキャッシュ付きの単一プレビュー/サムネイル一覧で、マスク結果を確認しながら調整。マスク重ね表示は360°表示/パース表示の両方に反映されます
